            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-start gap-3 mb-4">
                        <h6 class="mb-0 fs-2 mx-auto">Payment List</h6>
                        <div></div>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                $sql = "
                                         ...
                                         payments.total_tuition, 
                                         payments.payment_semester AS semester, 
                                         payments.student_name, 
                                         programme.programme_code,
                                         payments.subject_count
                                         FROM 
                                         payments 
                                         JOIN 
                                         students 
                                         ...
                                         programme 
                                         ON 
                                         students.programme_id = programme.id_programme
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <td>$" . number_format($row['total_tuition'], 0) . "</td>   
